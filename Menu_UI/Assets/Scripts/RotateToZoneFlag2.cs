...
public class RotateToZoneFlag2 : MonoBehaviour
{
    public GameObject zoneFlag2;
    ...
    {
        if (zoneFlag2 != null && cameraParent != null)
        {
            if (orbitalCamera != null)
            {
            ...
            Vector3 direction = zoneFlag2.transform.position - cameraParent.position;
